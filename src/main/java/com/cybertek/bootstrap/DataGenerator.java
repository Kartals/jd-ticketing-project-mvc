...
public class DataGenerator implements CommandLineRunner {
    // CommandLineRunner bir interface'tir ve run isimli, override yapmamız gereken bir abstract method ile birlikte gelir
    ...
    @Override
    public void run(String... args) throws Exception {   // Whenever we start SpringBoot application, it (springBoot) will run first this run method.
